...
UIController = (function(){
  ...
  var DOMstrings = {
    ...
    container: '.container',
    expensesPercLabel: '.item__percentages',
  ...
  return {
    ...
    changedType: function(){
      ...
      var fields = document.querySelectorAll(
          DOMstrings.inputType + ','+ DOMstrings.addDescription + ','+ DOMstrings.addValue
      );
...
var controller = (function(budgetCtrl, UICtrl){
  ...
  var updateBudget = function(){
    ...
    //1. Calculate the budvget
        budgetCtrl.calculateBudget();
    //2. Return the budget
          var budget = budgetCtrl.getBudget();


        //5. Display the budget on the UI3
